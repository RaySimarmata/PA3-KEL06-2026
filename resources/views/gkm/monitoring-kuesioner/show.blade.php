                    ...
                    <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($kuesioner->jenis_kuesioner)
                                                <span class="badge bg-info">{{ $kuesioner->jenis_kuesioner }}</span>
                                            @else
                                                -
                                            @endif
                                        </td>
                        ...
                        @if ($kuesioner->status === 'processing')
                            <div class="alert alert-warning">
                                ...
                                <p class="mb-0">
                                    AI Agent sedang menganalisis data kuesioner. Proses ini membutuhkan waktu beberapa
                                    menit.
                                                    ...
                                                    <div class="row mt-3">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="text-center">
                                                                ...
                                                                @endphp
                                                                <h4 class="text-info">
                                                                    {{ number_format($persenKepuasan, 2) }}%</h4>
                        ...
                        @if ($kuesioner->status === 'error')
                            <div class="alert alert-danger">
                                ...
                                <p class="mb-2">
                                    ...
                                    tombol "Proses Ulang dengan AI" di atas.
                                </p>
                                @if (isset($kuesioner->hasil_analisis['error']))
                                    <small class="text-muted">Detail error:
                                        {{ $kuesioner->hasil_analisis['error'] }}</small>
                                @endif
                            </div>
                        @endif
                    </div>
