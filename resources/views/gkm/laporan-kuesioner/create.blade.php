                                ...
                                <div class="ai-input-area">
                                    <div
                                        ...
                                        <textarea class="ai-textarea-inline" id="ai-prompt-input"
                                            placeholder="Deskripsikan laporan kuesioner yang ingin Anda buat..." style="margin-left: 0.5rem;"></textarea>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            btnAskAI.addEventListener('click', async function() {
                ...
                try {
                    ...
                    let response;
                    try {
                        response = await fetch('{{ route('gkm.laporan-kuesioner.ai-prompt') }}', {
                            method: 'POST',
                            body: formData,
                            headers: {
                                'Accept': 'application/json'
                    ...
                    if (data.success) {
                        ...
                        // Auto-download jika auto_generated = true
                            ...
                            setTimeout(() => {
                                appendAIMessage(`
                                    <div style="background: #ffffff; color: #1e3c72; padding: 16px; border-radius: 12px; margin: 12px 0; border: 2px solid #10b981;">
                                        ...
                                        <a href="${data.download_url}" class="btn btn-sm" download style="display: inline-flex; align-items: center; gap: 8px; padding: 8px 16px; border-radius: 8px; text-decoration: none; background: #10b981; color: white; font-weight: 600;">
            ...
            async function saveAIPreviewToDatabase(laporanId, aiResponse, sections) {
                ...
                try {
                    ...
                    await fetch('{{ route('gkm.laporan-kuesioner.save-preview') }}', {
                        method: 'POST',
                        body: formData,
                        headers: {
                            'Accept': 'application/json'
            ...
            function showAutoDownloadToast() {
                ...
                toast.style.cssText = `
                    ...
                    color: white; padding: 16px 24px; border-radius: 12px; box-shadow: 0 8px 24px rgba(16, 185, 129, 0.3);
                    z-index: 9999; display: flex; align-items: center; gap: 12px; font-size: 14px; font-weight: 600;
                ...
                toast.innerHTML = `
                    ...
                    <div>
                        ...
                        <div style="font-size: 12px; opacity: 0.9; font-weight: 400;">File sedang didownload...</div>
                    </div>
                `;
            ...
            appendAIMessage(`
                ...
                Saya siap membantu Anda membuat laporan kuesioner kepuasan mahasiswa yang komprehensif. Silakan:<br><br>
                1. Klik <strong>"Buat Laporan Draft"</strong> terlebih dahulu<br>
                2. Ketik instruksi atau deskripsi laporan yang diinginkan<br>
                3. Saya akan mengambil data kuesioner dari database dan membantu generate draft laporan untuk Anda
            `);
        });
    </script>
@endsection
