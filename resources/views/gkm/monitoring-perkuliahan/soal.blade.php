...
@section('page-title', 'Kirim Reminder Review Soal')
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h5 class="mb-1">Kirim Reminder Review Soal Ujian</h5>
                    <p class="text-muted mb-0">Kirimkan reminder kepada Kepala Program Studi untuk review soal ujian</p>
                </div>
        ...
        <div class="card border-0 shadow-sm mb-4">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h6 class="mb-0">Pilih Kaprodi</h6>
                    <div>
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($dosen->prodi)
                                        <span class="badge bg-primary">{{ $dosen->prodi->nama_prodi }}</span>
                                    @else
                                        <span class="text-muted">-</span>
                                    @endif
                                </td>
                                <td>
                                    <span class="badge bg-success">Kepala Prodi</span>
                                </td>
                            </tr>
                            @empty
                            <tr>
                                <td colspan="6" class="text-center py-4">Tidak ada data Kaprodi</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                ...
                <div class="d-flex gap-2">
                    <button type="button" class="btn btn-success" onclick="generateMessage()">
