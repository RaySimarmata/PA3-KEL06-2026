                ...
                <div style="padding: 1.5rem;">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control" name="subject" id="subject"
                            placeholder="Contoh: Pengumpulan Laporan Bulanan" required>
                    </div>
                                            ...
                                            <tbody>
                                                @forelse($laporanList as $laporan)
                                                    <tr>
                                                        ...
                                                        <td class="code-mk">{{ $laporan->bulan }} {{ $laporan->tahun }}
                                                        </td>
    ...
    <script>
        ...
        document.getElementById('tempAttachments').addEventListener('change', function(e) {
            ...
            if (this.files.length > 0) {
                ...
                filesDiv.innerHTML =
                    '<div style="padding: 1rem;"><h6 class="mb-3" style="font-weight: 600; color: #333;">File yang Dipilih - Validasi:</h6></div>';
        ...
        function showLaporanValidation() {
            ...
            if (selectedCheckboxes.length > 0) {
                ...
                laporanDiv.innerHTML =
                    '<div style="padding: 1rem;"><h6 class="mb-3" style="font-weight: 600; color: #333;">Laporan yang Dipilih - Validasi:</h6></div>';
        ...
        function updateValidatedFilesDisplay() {
            ...
            if (validatedFiles.laporan.length > 0) {
                const laporanDiv = document.createElement('div');
                laporanDiv.innerHTML =
                    '<strong class="text-success"><i class="bi bi-file-earmark-text"></i> Laporan dari Pelaporan:</strong>';
        ...
        function sendLaporan() {
            ...
            AppConfirm.custom({
                ...
                message: 'Reminder akan dikirim ke penerima yang dipilih.',
                okText: 'Ya, Kirim'
            }, function() {
