...
<div style="padding: 1.5rem;">
    ...
    <div class="filter-card mb-4">
        <div style="display: flex; align-items: center; gap: 1rem;">
            <div style="width: 48px; height: 48px; background: linear-gradient(135deg, #1e3c72 0%, #2a5298 100%); border-radius: 10px; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
    ...
    <div class="monitoring-card">
        <div class="monitoring-header">
            ...
            <div style="margin-left: auto;">
                <a href="{{ route('gkm.reminder-agent.index') }}" class="btn btn-outline-secondary btn-sm">
        ...
        <div style="padding: 1.5rem;">
            ...
            <form action="{{ route('gkm.reminder-agent.jadwal.update', $jadwal->id) }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <label for="tipe_reminder" class="form-label">Tipe Reminder <span class="text-danger">*</span></label>
                        <select class="form-select @error('tipe_reminder') is-invalid @enderror"
                                id="tipe_reminder" 
                                name="tipe_reminder" 
                                required>
                            <option value="">Pilih Tipe Reminder</option>
                            <option value="RPS" {{ old('tipe_reminder', $jadwal->tipe_reminder) == 'RPS' ? 'selected' : '' }}>
                                Reminder RPS
                            </option>
                            <option value="Upload Materi" {{ old('tipe_reminder', $jadwal->tipe_reminder) == 'Upload Materi' ? 'selected' : '' }}>
                                Reminder Upload Materi
                            </option>
                            <option value="Review Soal" {{ old('tipe_reminder', $jadwal->tipe_reminder) == 'Review Soal' ? 'selected' : '' }}>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="time" 
                               class="form-control @error('jam_pengiriman') is-invalid @enderror"
                               id="jam_pengiriman" 
                               name="jam_pengiriman"
                               value="{{ old('jam_pengiriman', $jadwal->jam_pengiriman) }}" 
                               required>
                        <small class="text-muted">
