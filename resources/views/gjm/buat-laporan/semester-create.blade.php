...
@section('styles')
    <style>
        ...
        .ai-chat-wrapper {
            background: linear-gradient(135deg, rgba(30, 60, 114, 0.04) 0%, rgba(30, 60, 114, 0.08) 100%);
            border: 1.5px solid rgba(30, 60, 114, 0.18);
            border-radius: 16px;
            overflow: hidden;
        }
        ...
        .ai-messages:empty::after {
            content: "Ketik instruksi Anda di bawah, lalu tekan Enter untuk generate...";
            color: #9ca3af;
            font-size: 0.875rem;
            font-style: italic;
            text-align: center;
        ...
        .file-upload-zone {
            border: 1.5px dashed rgba(30, 60, 114, 0.22);
            border-radius: 10px;
        ...
        .file-chip {
            ...
            border: 1px solid rgba(30, 60, 114, 0.35);
            border-radius: 8px;
            padding: 0.4rem 0.6rem;
            font-size: 0.75rem;
            color: #1e3c72;
            ...
            <div style="padding: 1.5rem;">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="d-flex align-items-start gap-3">
                        ...
                        <div>
                            <h6 class="mb-1" style="font-weight: 600; color: #333;"></h6>
        ...
        document.addEventListener('DOMContentLoaded', function() {
                    ...
                    if (data.success) {
                        ...
                        if (successCount > 0 && textLength > 0) {
                            ocrMsg =
                                ...
                                `✓ Konten tervalidasi relevan dengan Laporan Semester<br><br>` +
                            ...
                            appendAIMessage(`
                                <div style="background:#fef2f2;border-left:4px solid #dc2626;padding:16px;border-radius:8px;margin:8px 0;">
                                    <p style="color:#dc2626;margin:0 0 12px 0;font-weight:600;font-size:16px;">
                                        <i class="bi bi-exclamation-triangle-fill"></i> Gambar Tidak Relevan dengan Laporan Semester
                                    </p>
            ...
            async function saveAIPreviewToDatabase(laporanId, aiResponse, sections) {
                ...
                try {
                    ...
                    const response = await fetch('{{ route('gjm.buat-laporan.semester.save-preview') }}', {
                        method: 'POST',
                        body: formData,
                        headers: {
                            'Accept': 'application/json',
