...
@section('page-title', 'Upload Template Laporan VMTS')
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h5 class="mb-1 d-flex align-items-center gap-2" style="font-weight: 600; color: #333;">
                        Upload Template Laporan VMTS
                    </h5>
                    <p class="text-muted mb-0" style="font-size: 0.875rem;">Upload file Word (.docx) sebagai template untuk
                        Laporan VMTS</p>
                </div>
                <a href="{{ route('gjm.template-laporan.vmts.index') }}" class="btn btn-outline-secondary">
            ...
            <div class="col-lg-8 mx-auto">
                ...
                <div class="monitoring-card mb-4" style="border-left: 4px solid #5B9BD5;">
                    <div style="padding: 1.5rem;">
                        <div class="d-flex align-items-start">
                            ...
                            <div>
                                <h6 class="mb-2" style="font-weight: 600; color: #333;">Panduan Upload Template VMTS</h6>
                                <ul class="mb-0" style="font-size: 0.875rem; color: #495057; line-height: 1.8;">
                                    ...
                                    <li>Template ini akan digunakan untuk laporan VMTS (Visi Misi Tujuan Sasaran)</li>
                ...
                <div class="monitoring-card">
                    <div class="monitoring-header">
                        <h6>Form Upload Template VMTS</h6>
                    </div>
                    <div style="padding: 1.5rem;">
                        <form action="{{ route('gjm.template-laporan.vmts.store') }}" method="POST"
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="nama_template" id="nama_template"
                                    ...
                                    value="{{ old('nama_template') }}" placeholder="Contoh: Template Laporan VMTS 2026"
                                    required>
                                @error('nama_template')
