...
@section('page-title', 'Upload Template Laporan Triwulan')
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h5 class="mb-1 d-flex align-items-center gap-2" style="font-weight: 600; color: #333;">
                        ...
                        Upload Template Laporan Triwulan
                    </h5>
                    <p class="text-muted mb-0" style="font-size: 0.875rem;">Upload file Word (.docx) sebagai template untuk Laporan Triwulan</p>
                </div>
                <a href="{{ route('gjm.template-laporan.triwulan.index') }}" class="btn btn-outline-secondary">
        ...
        <div class="row">
            <div class="col-lg-8 mx-auto">
                        ...
                        <div class="d-flex align-items-start">
                            ...
                            <div>
                                ...
                                <ul class="mb-0" style="font-size: 0.875rem; color: #495057; line-height: 1.8;">
                                    ...
                                    <li>Template ini akan digunakan untuk laporan triwulan (3 bulanan)</li>
                                ...
                                <div class="mt-3" style="font-size: 0.8rem; color: #6b7280;">
                                    <strong>Periode Triwulan:</strong><br>
                                    • Triwulan I: Januari - Maret<br>
                                    • Triwulan II: April - Juni<br>
                                    • Triwulan III: Juli - September<br>
                ...
                <div class="monitoring-card">
                    ...
                    <div style="padding: 1.5rem;">
                        <form action="{{ route('gjm.template-laporan.triwulan.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" 
                                       ...
                                       placeholder="Contoh: Template Laporan Triwulan 2026"
                                       required>
                                @error('nama_template')
