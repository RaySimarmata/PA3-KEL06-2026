...
@section('page-title', 'Upload Template Laporan Semester')
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h5 class="mb-1 d-flex align-items-center gap-2" style="font-weight: 600; color: #333;">
                        ...
                        Upload Template Laporan Semester
                    </h5>
                    <p class="text-muted mb-0" style="font-size: 0.875rem;">Upload file Word (.docx) sebagai template untuk Laporan Semester</p>
                </div>
                <a href="{{ route('gjm.template-laporan.semester.index') }}" class="btn btn-outline-secondary">
        ...
        <div class="row">
            <div class="col-lg-8 mx-auto">
                ...
                <div class="monitoring-card">
                    ...
                    <div style="padding: 1.5rem;">
                        <form action="{{ route('gjm.template-laporan.semester.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" 
                                       ...
                                       placeholder="Contoh: Template Laporan Semester 2026"
                                       required>
                                @error('nama_template')
