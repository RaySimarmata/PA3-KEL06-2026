...
<body>
    ...
    <style>
        ...
        .alert-app .alert-app-body { flex: 1; }
        ...
        .alert-app .alert-app-close:hover { opacity: 1; }
        ...
        .alert-gkm.success, .alert-gjm.success {
            background-color: #d1f0e0; color: #0f5132; border-left: 4px solid #198754;
        }
        .alert-gkm.danger, .alert-gjm.danger {
            background-color: #fde8ea; color: #842029; border-left: 4px solid #dc3545;
        }
        .alert-gkm.warning, .alert-gjm.warning {
            background-color: #fff4cc; color: #664d03; border-left: 4px solid #ffc107;
        }
        .alert-gkm.info, .alert-gjm.info {
            background-color: #dceefb; color: #084298; border-left: 4px solid #0d6efd;
        }
        ...
        #globalConfirmModal.active { display: flex; }
    ...
    (function() {
        ...
        window.AppConfirm = {
            delete: function(form, msg) {
                _pendingForm = form;
                show({ type:'delete', title:'Hapus Data?', message: msg || 'Data yang dihapus tidak dapat dikembalikan.', okText:'Ya, Hapus' });
            },
            ask: function(form, title, msg) {
                _pendingForm = form;
                show({ type:'info', title: title, message: msg, okText:'Ya, Lanjutkan' });
            },
            process: function(form, title, msg) {
                _pendingForm = form;
                show({ type:'process', title: title, message: msg, okText:'Ya, Proses' });
            },
