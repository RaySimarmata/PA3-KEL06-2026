...
class DebugMonitoringRPSGanjil extends Command
{
    protected $signature = 'debug:monitoring-rps-ganjil {prodi_id=4} {ta=2020}';
    protected $description = 'Debug Monitoring RPS untuk Semester Ganjil';
    ...
    public function handle()
    {
        ...
        $this->info("=== DEBUG MONITORING RPS SEMESTER GANJIL ===");
        $this->info("Prodi ID: {$prodiId}, TA: {$ta}, Semester: Ganjil (1)");
        $this->newLine();
        ...
        if (Cache::has($cacheKey)) {
            ...
            $this->comment("   php artisan cache:clear-monitoring-rps 1 2020");
        } else {
