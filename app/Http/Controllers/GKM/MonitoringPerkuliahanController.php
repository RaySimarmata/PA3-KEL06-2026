            ...
            try {
                try {
                    $request->validate([
                        ...
                        'subject' => 'required|string', // Accept both 'subject' and 'subjek'
                ...
                $subject = $request->subject ?? $request->subjek ?? 'Reminder Upload Materi';
                    ...
                    try {
                        ...
                        if (!empty($email)) {
                            try {
                                ...
                                $errors[] = "Email ke {$dosen->nama}: " . $mailEx->getMessage();
                            }
                        }
