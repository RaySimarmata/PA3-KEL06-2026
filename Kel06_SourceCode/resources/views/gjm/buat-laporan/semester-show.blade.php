...
@section('page-title', 'Detail Laporan Semester')
        ...
        <div class="monitoring-card">
            ...
            <div style="padding: 1.5rem;">
                ...
                @if($laporan->status_laporan == 'completed' && $laporan->file_word)
                    <div class="mt-4">
                        <a href="{{ route('gjm.buat-laporan.semester.download', [$laporan->id, 'word']) }}" class="btn btn-success">
