...
@section('page-title', 'Upload Template Semester Baru')
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h5 class="mb-1 d-flex align-items-center gap-2" style="font-weight: 600; color: #333;">
                        <i class="bi bi-upload" style="color: #28a745;"></i>
                        Upload Template Laporan Semester Baru
                    </h5>
                    <p class="text-muted mb-0" style="font-size: 0.875rem;">Upload file Word (.docx) sebagai template untuk laporan semester GJM</p>
                </div>
                <a href="{{ route('gjm.buat-laporan.template-semester.index') }}" class="btn btn-outline-secondary">
            ...
            <div class="col-lg-8 mx-auto">
                ...
                <div class="monitoring-card mb-4" style="border-left: 4px solid #28a745;">
                    <div style="padding: 1.5rem;">
                        <div class="d-flex align-items-start">
                            ...
                            <div>
                                <h6 class="mb-2" style="font-weight: 600; color: #333;">Panduan Upload Template Semester</h6>
                                <ul class="mb-0" style="font-size: 0.875rem; color: #495057; line-height: 1.8;">
                                    ...
                                    <li>Template khusus untuk laporan semester (6 bulan)</li>
                ...
                <div class="monitoring-card">
                    <div class="monitoring-header">
                        <i class="bi bi-upload" style="color: #28a745;"></i>
                        <h6>Form Upload Template Semester</h6>
                    </div>
                    <div style="padding: 1.5rem;">
                        <form action="{{ route('gjm.buat-laporan.template-semester.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" 
                                       ...
                                       placeholder="Contoh: Template Laporan Semester GJM 2026"
                                       required>
                                @error('nama_template')
