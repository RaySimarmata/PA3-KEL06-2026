...
<body>
    <div class="header">
        ...
        <p style="margin: 5px 0;">Reminder Upload RPS</p>
    </div>

    <div class="content">
        <div class="message">
            <pre
                style="margin: 0; padding: 0; font-family: Arial, sans-serif; white-space: pre-wrap; word-wrap: break-word; text-align: left;">{{ $messageContent }}</pre>
        </div>
