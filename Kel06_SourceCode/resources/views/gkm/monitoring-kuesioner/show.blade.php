...
@section('content')
                ...
                <div class="d-flex gap-2 flex-wrap">
                    ...
                    @if (in_array($kuesioner->status, ['error', 'uploaded']))
                        <form action="{{ route('gkm.monitoring-kuesioner.reprocess', $kuesioner->id) }}"
                            ...
                            @csrf
                            <button type="submit" class="btn-proses-ulang">
                                <i class="bi bi-arrow-clockwise"></i> Proses Ulang
                            </button>
                        </form>
                    @endif
                    <a href="{{ route('gkm.monitoring-kuesioner.index') }}" class="btn-kembali">
    ...
    <style>
        /* Button Lihat - Biru tua, tidak berubah saat hover */
        .btn-lihat {
        ...
        /* Button Proses Ulang - Kuning/Warning, tidak berubah saat hover */
        .btn-proses-ulang {
        ...
        .btn-proses-ulang:hover,
        .btn-proses-ulang:focus,
        .btn-proses-ulang:active,
        .btn-proses-ulang:active:focus {
            background-color: #ffc107 !important;
        ...
        /* Button Kembali - Abu-abu, tidak berubah saat hover */
        .btn-kembali {
        ...
        /* Button Download - Hijau, tidak berubah saat hover */
        .btn-download-file {
        ...
        .btn-download-file:active:focus,
        .btn-download-file:visited {
            background-color: #28a745 !important;
