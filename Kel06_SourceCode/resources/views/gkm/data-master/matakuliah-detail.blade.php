                        ...
                        @forelse($dosenPengajar as $index => $dosen)
                            <tr>
                                ...
                                <td class="text-center">
                                    <form action="{{ route('gkm.data-master.matakuliah.dosen.delete') }}" method="POST"
                                        onsubmit="AppConfirm.delete(this, 'Dosen ini akan dihapus dari matakuliah.'); return false;"
                    ...
                    <form action="{{ route('gkm.data-master.matakuliah.dosen.store') }}" method="POST">
                        ...
                        <div class="modal-body" style="padding: 1.5rem;">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="pegawai_id" id="pegawaiId" class="form-control" readonly
                                    required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="nama_dosen" id="namaDosen" class="form-control" readonly
                                    required>
                            </div>
                        </div>
