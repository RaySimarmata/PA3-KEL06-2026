                ...
                <div class="d-flex align-items-start">
                    ...
                    <div>
                        ...
                        <p class="mb-2" style="font-size: 0.875rem; color: #495057; line-height: 1.6;">
                            ...
                            menghasilkan laporan artefak yang konsisten.
                        </p>
                                ...
                                <td>
                                    <div class="d-flex flex-column align-items-center gap-2">
                                        <div class="btn-group" role="group">
                                            <a href="{{ route('gkm.laporan-artefak.template.download', $template->id) }}" 
                                               class="btn btn-sm btn-outline-primary" 
                                               title="Download Template">
                                                <i class="bi bi-download"></i>
                                            </a>
                                            
                                            <form action="{{ route('gkm.laporan-artefak.template.reindex', $template->id) }}" 
                                            ...
                                            <form action="{{ route('gkm.laporan-artefak.template.toggle', $template->id) }}" 
                                                  method="POST" class="d-inline">
                                                @csrf
                                                <button type="submit" 
