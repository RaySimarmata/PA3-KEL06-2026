    ...
    async handleFileUpload(files) {
        ...
        if (imageFiles.length > 0) {
            try {
                ...
                this.addMessage('system', `⚠️ Validasi gambar gagal: ${error.message}<br><br>Gambar tetap diupload, tetapi mungkin tidak relevan dengan Laporan Triwulan.`);
            }
        }
    ...
    async callAIService(message, files = []) {
        ...
        if (modifySectionMatch) {
            ...
            if (lastFullDraft) {
                ...
                this.addMessage('system', '⚠️ <strong>Peringatan:</strong> Tidak ada draft lengkap sebelumnya. Untuk hasil terbaik, buat draft lengkap terlebih dahulu dengan perintah "Buat laporan triwulan lengkap", lalu ubah bagian yang diinginkan.');
            }
        }
